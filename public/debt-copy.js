...
const applyDebtCopy = () => {
  ...
  if (!document.querySelector("[data-brand-logo-style]")) {
    ...
    style.textContent = `
      ...
      .HomeQuadrants .quadrant:not(:hover):not(:focus):not(:focus-within) .hidden-content,
      .HomeQuadrants .quadrant:not(:hover):not(:focus):not(:focus-within) .quadrant__imageContainer {
        opacity: 0 !important;
        pointer-events: none !important;
        visibility: hidden !important;
      }
      ...
      .HomeQuadrants:hover .hidden-content,
      .HomeQuadrants:focus-within .hidden-content,
      .HomeQuadrants.is-section-hover .hidden-content,
      ...
      .HomeQuadrants:hover .quadrant__imageContainer,
      .HomeQuadrants:focus-within .quadrant__imageContainer,
      .HomeQuadrants.is-section-hover .quadrant__imageContainer {
        opacity: 1 !important;
      ...
      .HomeQuadrants .quadrant__imageContainer {
        display: block !important;
        opacity: 1 !important;
        pointer-events: auto !important;
        visibility: visible !important;
...
.HomeWheel .HomeWheel__contentBlock {
  ...
  color: #ffffff !important;
      ...
      .HomeQuadrants {
        background: #ffffff !important;
        background-image:
          linear-gradient(rgba(15, 127, 119, .24) 1px, transparent 1px),
          linear-gradient(90deg, rgba(15, 127, 119, .24) 1px, transparent 1px) !important;
        background-size: 48px 48px !important;
        display: block !important;
      ...
      .HomeQuadrants > .heading.sr-only,
      .HomeQuadrants > .overlay {
        display: none !important;
      }
      .HomeQuadrants .background {
        inset: 0 !important;
      ...
      .HomeQuadrants > .reactive-divider,
      .HomeQuadrants .center,
      #HomeQuadrants__logo,
      #HomeQuadrants__logoMask {
        display: none !important;
      ...
      .HomeQuadrants .quadrant {
        align-items: center !important;
        background: transparent !important;
        border-color: rgba(15, 127, 119, .34) !important;
        border-style: solid !important;
        border-width: 0 1px 1px 0 !important;
        display: grid !important;
        gap: clamp(1.5rem, 3vw, 3.5rem) !important;
        grid-template-columns: minmax(0, 1fr) clamp(10rem, 16vw, 17rem) !important;
        height: auto !important;
        min-height: clamp(30rem, 42vw, 38rem) !important;
        overflow: hidden !important;
      ...
      .HomeQuadrants .quadrant.erg-quadrant-1 {
        grid-column: 1 !important;
        grid-row: 1 !important;
      }
      .HomeQuadrants .quadrant.erg-quadrant-2 {
        grid-column: 2 !important;
        grid-row: 1 !important;
      }
      .HomeQuadrants .quadrant.erg-quadrant-3 {
        grid-column: 1 !important;
        grid-row: 2 !important;
      }
      .HomeQuadrants .quadrant.erg-quadrant-4 {
        grid-column: 2 !important;
        grid-row: 2 !important;
      }
      .HomeQuadrants .quadrant:nth-of-type(2n) {
      ...
      .HomeQuadrants .heading,
      .HomeQuadrants .quadrant__heading {
      ...
      .HomeQuadrants .btn,
      .HomeQuadrants a[class*="btn"],
      .HomeQuadrants button {
        align-items: center !important;
      ...
      .HomeQuadrants .quadrant__imageContainer {
        display: block !important;
        height: clamp(18rem, 30vw, 28rem) !important;
        inset: auto !important;
      ...
      .HomeQuadrants .quadrant__imageContainerInner {
        height: 100% !important;
        inset: auto !important;
        position: relative !important;
        transform: none !important;
      ...
      .HomeQuadrants .quadrant__image--top,
      .HomeQuadrants .quadrant__image--bottom {
        display: none !important;
      }
      .HomeQuadrants .quadrant__image img {
        height: 100% !important;
        object-fit: cover !important;
        object-position: top center !important;
        width: 100% !important;
      ...
      @media (max-width: 48rem) {
        ...
        .HomeQuadrants .quadrant {
          ...
          border: 1px solid rgba(15, 127, 119, .22) !important;
          border-radius: 1rem !important;
          box-shadow: 0 .85rem 1.7rem rgba(0, 0, 0, .13) !important;
          display: grid !important;
          gap: 1rem !important;
          grid-column: auto !important;
          grid-template-columns: 1fr !important;
  ...
  document.querySelectorAll(".HomeQuadrants .quadrant").forEach(quadrant => {
    const quadrantIndex = [...document.querySelectorAll(".HomeQuadrants .quadrant")].indexOf(quadrant) + 1;
    quadrant.classList.add(`erg-quadrant-${quadrantIndex}`);
    ...
    quadrant.addEventListener("mouseleave", () => quadrant.classList.remove("is-active"));
  });
  if (!window.__homeQuadrantsActiveBound) {
    ...
    document.addEventListener("pointerout", event => {
      const quadrant = event.target.closest?.(".HomeQuadrants .quadrant");
      if (quadrant && !quadrant.contains(event.relatedTarget)) quadrant.classList.remove("is-active");
    }, true);
    const syncSectionHover = event => {
      const section = document.querySelector(".HomeQuadrants");
      if (!section) return;
      const rect = section.getBoundingClientRect();
      const inside = event.clientX >= rect.left && event.clientX <= rect.right && event.clientY >= rect.top && event.clientY <= rect.bottom;
      section.classList.toggle("is-section-hover", inside);
      section.querySelectorAll(".hidden-content").forEach(element => {
        element.style.display = inside ? "grid" : "";
        element.style.opacity = inside ? "1" : "";
        element.style.pointerEvents = inside ? "auto" : "";
        element.style.visibility = inside ? "visible" : "";
      });
      section.querySelectorAll(".quadrant__imageContainer").forEach(element => {
        element.style.display = inside ? "block" : "";
        element.style.opacity = inside ? "1" : "";
        element.style.pointerEvents = inside ? "auto" : "";
        element.style.visibility = inside ? "visible" : "";
      });
    };
    document.addEventListener("mousemove", syncSectionHover, true);
    document.addEventListener("click", syncSectionHover, true);
  }
